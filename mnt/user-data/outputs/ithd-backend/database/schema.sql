-- backend/database/schema.sql (FINAL FIX)
...
-- ============================================
-- STORED PROCEDURE 1: Get user by empCode
-- ============================================
...
-- ============================================
-- STORED PROCEDURE 2: Get ticket with details
-- ============================================
...
-- ============================================
-- STORED PROCEDURE 3: Get all tickets (simple version)
-- ============================================
...
BEGIN
    ...
    WHERE 
        (@isITStaff = 1) OR (t.empCode_created = @empCode)
...
-- ============================================
-- STORED PROCEDURE 4: Get email statistics
-- ============================================
...
-- ============================================
-- STORED PROCEDURE 5: Get ticket statistics
-- ============================================
...
BEGIN
    ...
    WHERE 
        (@isITStaff = 1) OR (empCode_created = @empCode);
END;
...
WHERE ROUTINE_SCHEMA = 'dbo' AND ROUTINE_NAME LIKE 'sp_ithd_%'
ORDER BY ROUTINE_NAME;

PRINT '';
PRINT 'Sample data:';
SELECT COUNT(*) as 'Total Users' FROM dbo.ithd_users;
